...
sap.ui.define([
	...
	return BaseController.extend("de.mindsquare.zph_Thesis.controller.Home", {
		onInit: function () {
		},
		...
		onListItemPressed: function (oEvent) {
			...
			//console.log(oItem);
			//console.log(oCtx);
			//console.log(oCtx.getProperty("Instandhaltungsauftrag"));
			this.getRouter().navTo("IhOrder", {
				ihOrderId: 0
				//ihOrderId : oCtx.getProperty("Instandhaltungsauftrag")
			});
			console.log("Jetzt sollte ich mich hier befinden:" + oCtx.getProperty("Instandhaltungsauftrag"));

		},

		onFilterMaintenanceOrders: function (oEvent) {
			...
			if (sQuery) {
				aFilter.push(new Filter({
					filters: [new Filter("Instandhaltungsauftrag", FilterOperator.Contains, sQuery),
					new Filter("Equipment", FilterOperator.Contains, sQuery),
					new Filter("TechnPlatz", FilterOperator.Contains, sQuery)
					]
				})
			...
			//filter Binding:
			var oList = this.getView().byId("maintenanceOrderList");
